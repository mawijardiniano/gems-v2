              ...
              <div className="px-4 pt-4 pb-3 border-b border-gray-50">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <span className="inline-flex items-center gap-1 mt-1 px-2 py-0.5 bg-rose-50 text-rose-700 text-[10px] font-semibold rounded-full uppercase tracking-wider">
                      {isGadRole ? "GAD Staff" : "Planning Director"}
                    </span>
                  </div>
                </div>
              </div>
