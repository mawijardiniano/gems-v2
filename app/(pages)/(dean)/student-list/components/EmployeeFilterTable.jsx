  ...
  return (
    <div className="flex flex-wrap gap-4 mb-6">
      ...
      <div className="relative" ref={collegeRef}>
        ...
        >
          <span className="truncate mr-2">Offices</span>
        ...
        {collegeOpen && (
          <div className="absolute z-10 mt-1 w-64 bg-white border rounded shadow max-h-48 overflow-auto p-2">
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm text-gray-600">Select Offices</span>
              <button
                type="button"
      ...
      <div className="relative" ref={appointmentRef}>
        ...
        >
          ...
          {Array.isArray(filterAppointment) && filterAppointment.length > 0 && (
            <span className="ml-2 inline-block bg-blue-100 text-blue-800 text-xs px-2 py-0.5 rounded">
              {filterAppointment.length}
            </span>
          )}
          <HiChevronDown
            className={`ml-2 transition-transform duration-150 ${appointmentOpen ? "rotate-180" : ""}`}
          />
        </button>
        {appointmentOpen && (
          <div className="absolute z-10 mt-1 w-64 bg-white border rounded shadow max-h-48 overflow-auto p-2">
