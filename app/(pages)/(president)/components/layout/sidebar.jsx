...
export default function Sidebar({ open, setOpen, role }) {
  ...
  useEffect(() => {
    if (pathname?.startsWith("/president/project-monitoring")) {
      setShowProjectMonitoring(true);
    }
    if (pathname?.startsWith("/president/gender-statistics")) {
  ...
  const isActive = useCallback(
    (href) => {
      if (href === "/president/dashboard")
        return pathname === "/president/dashboard";
  ...
  const getDisplayName = useCallback(() => {
    ...
    return user?.username || "SUC President";
  }, [profile, user]);
      ...
      >
          ...
          {open ? (
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px] font-medium text-amber-600 truncate mt-0.5 uppercase tracking-wider">
                  SUC President
                </p>
              </div>
            </div>
        ...
        >
          ...
          {open ? (
            <div>
              <button
                onClick={() => setShowProjectMonitoring((prev) => !prev)}
                className={`relative flex items-center gap-3 rounded-xl transition-all duration-200 w-full p-2.5 ${
                  showProjectMonitoring || pathname?.startsWith("/president/project-monitoring")
                    ? "bg-gradient-to-r from-amber-50 to-yellow-50/50 text-amber-700"
                    : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                }`}
              >
              ...
              {showProjectMonitoring && (
                <div className="ml-6 mt-1 space-y-1 border-l border-gray-200 pl-3">
                  ...
                  <TooltipWrapper label="Event Calendar" collapsed={!open}>
                    <Link
                      href="/president/project-monitoring/event-calendar"
                      onClick={handleMobileClose}
                      className={`relative flex items-center gap-3 rounded-xl transition-all duration-200 group p-2.5 ${
                        pathname?.startsWith(
                          "/president/project-monitoring/event-calendar",
                        )
                          ? "bg-gradient-to-r from-amber-50 to-yellow-50/50 text-amber-700"
                          : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                      }`}
            ...
            <TooltipWrapper label="Project Monitoring" collapsed={!open}>
              <Link
                ...
                className={`relative flex items-center gap-3 rounded-xl transition-all duration-200 group p-3 justify-center mx-1.5 ${
                  pathname?.startsWith("/president/project-monitoring")
                    ? "bg-gradient-to-r from-amber-50 to-yellow-50/50 text-amber-700"
                    : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                }`}
              >
          ...
          {open ? (
            <div>
              <button
                onClick={() => setShowGenderStatistics((prev) => !prev)}
                className={`relative flex items-center gap-3 rounded-xl transition-all duration-200 w-full p-2.5 ${
                  showGenderStatistics || pathname?.startsWith("/president/gender-statistics")
                    ? "bg-gradient-to-r from-amber-50 to-yellow-50/50 text-amber-700"
                    : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                }`}
              >
                ...
                <div className="ml-6 mt-1 space-y-1 border-l border-gray-200 pl-3">
                  <TooltipWrapper label="Students" collapsed={!open}>
                    <Link
                      ...
                      className={`relative flex items-center gap-3 rounded-xl transition-all duration-200 group p-2.5 ${
                        pathname?.startsWith(
                          "/president/gender-statistics/students",
                        )
                          ? "bg-gradient-to-r from-amber-50 to-yellow-50/50 text-amber-700"
                          : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                      }`}
                  ...
                  <TooltipWrapper label="Employees" collapsed={!open}>
                    <Link
                      ...
                      className={`relative flex items-center gap-3 rounded-xl transition-all duration-200 group p-2.5 ${
                        pathname?.startsWith(
                          "/president/gender-statistics/employees",
                        )
                          ? "bg-gradient-to-r from-amber-50 to-yellow-50/50 text-amber-700"
                          : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                      }`}
            ...
            <TooltipWrapper label="Gender Statistics" collapsed={!open}>
              <Link
                ...
                onClick={handleMobileClose}
                className={`relative flex items-center gap-3 rounded-xl transition-all duration-200 group p-3 justify-center mx-1.5 ${
                  pathname?.startsWith("/president/gender-statistics")
                    ? "bg-gradient-to-r from-amber-50 to-yellow-50/50 text-amber-700"
                    : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                }`}
              >
