...
// Check if there are any queued attendance records
...
// NOTE: navigator.onLine is unreliable on mobile — it can return false
// even when the device has a working connection. Prefer trying the network
// directly instead of trusting this value.
